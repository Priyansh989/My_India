						...
						<div class="destination-details-content">
							...
							<div class="country-details">
								...
								<ul class="details-list clearfix">
									<li><i class="fas fa-map-marker-alt"></i><span>Customer ID:</span><?php echo $_SESSION['cutomer_id']; ?> </li>
									<li><i class="far fa-id-card"></i><span>User Name:</span><?php echo $username ?></li>
									<li><i class="fas fa-globe"></i><span>D.O.B:</span><?php echo date("d-m-Y", strtotime($datebirth));   ?></li>
									<li><i class="far fa-dollar-sign"></i><span>Phone:</span><?php echo $phone ?></li>
									<li><i class="fas fa-window-close"></i><span>ID Credential:</span><?php echo $idcr ?></li>
									<li><i class="fas fa-window-close"></i><span>Name:</span><?php echo $_SESSION['name']; ?> </li>
									<li><i class="fas fa-window-close"></i><span>Email-ID:</span><?php echo $email ?></li>
									<li><i class="fas fa-window-close"></i><span>Address:</span><?php echo $address ?></li>
									<li><i class="fas fa-window-close"></i><span>validation Satus:</span><?php echo $validation ?></li>
								</ul>
							</div>
							<div class="country-details">
								<div class="text">
								...
								<ul class="details-list clearfix">
									...
									$sql = "SELECT Ticket_id, Monument_name, date_of_visit FROM Booking_Details WHERE customer_ID ='" . $HELLO . "'";
